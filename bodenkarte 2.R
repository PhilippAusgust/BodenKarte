library("readxl")
library("writexl")
source("/Volumes/shared/Dokumente/R/Auswertung/gk_zu_gps.R")
source("/Volumes/shared/Dokumente/R/Auswertung/barycentric.R")
source("/Volumes/shared/Dokumente/R/Auswertung/color_functions.R")
library(leaflet)
raster <- read_excel("/Volumes/shared/Dokumente/R/Auswertung/GPS_nFK.xlsx", sheet = 1, col_names = TRUE, col_types = NULL, na = "", skip = 0)
...
showRectangleMarkers <- FALSE # values: TRUE or FALSE
